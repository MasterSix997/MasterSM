...
namespace Tests.Editor
{
    public class StateGroupTests
    {
        ...
        public void AddingStateGroup_ShouldAddAllStatesInGroup_WithCorrectPriorities()
        {
            ...
            Assert.AreEqual(10, _machine.GetState(State.State1).Priority);
            Assert.AreEqual(11, _machine.GetState(State.State2).Priority);
            Assert.AreEqual(12, _machine.GetState(State.State3).Priority);
        }
        ...
        public void AddingMultipleStateGroups_ShouldMaintainCorrectPriorities()
        {
            ...
            Assert.AreEqual(10, _machine.GetState(State.State1).Priority);
            Assert.AreEqual(11, _machine.GetState(State.State2).Priority);
            Assert.AreEqual(20, _machine.GetState(State.State3).Priority);
            Assert.AreEqual(21, _machine.GetState(State.State4).Priority);
